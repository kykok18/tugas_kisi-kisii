...
$query = mysqli_query($conn, "SELECT pendaftaran.*, users.nama, users.email FROM pendaftaran JOIN users ON pendaftaran.user_id = users.id WHERE pendaftaran.status='Menunggu Verifikasi'");
?>
<!DOCTYPE html>
<html lang="id">
...
<body>
    <div class="sidebar">
        ...
        <a href="verifikasi.php" class="active"><i class="bi bi-patch-check-fill"></i> Verifikasi</a>
    ...
    <div class="content">
        <div class="table-card">
            <h4 class="fw-bold mb-4">Verifikasi Pendaftar</h4>
                ...
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <?php if (mysqli_num_rows($query) == 0): ?>
                            <tr>
                                <td colspan="5" class="text-center">Tidak ada data yang menunggu verifikasi</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
